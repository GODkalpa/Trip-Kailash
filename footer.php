...
<footer class="tk-footer">
    <div class="tk-footer__container">
            ...
            <div class="tk-footer__links">
                ...
                <div class="tk-footer__column">
                    ...
                    <div class="tk-footer__social">
                        <a href="https://instagram.com/tripkailash" target="_blank" rel="noopener" aria-label="Instagram">
        ...
        <div class="tk-footer__bottom">
            <p>&copy; <?php echo date('Y'); ?> Trip Kailash. All rights reserved. IATA License: TK92456</p>
