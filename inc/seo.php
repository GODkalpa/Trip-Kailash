...
function tk_output_mobile_contact_buttons($phone, $whatsapp_message = '') {
    ...
    <div class="tk-mobile-contact-buttons">
        <a href="<?php echo esc_url($tel_link); ?>" class="tk-mobile-contact-btn tk-mobile-contact-btn--call" aria-label="<?php esc_attr_e('Call us', 'trip-kailash'); ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
            </svg>
            <span><?php esc_html_e('Call', 'trip-kailash'); ?></span>
        </a>
        <a href="<?php echo esc_url($wa_link); ?>" class="tk-mobile-contact-btn tk-mobile-contact-btn--whatsapp" target="_blank" rel="noopener" aria-label="<?php esc_attr_e('WhatsApp us', 'trip-kailash'); ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
