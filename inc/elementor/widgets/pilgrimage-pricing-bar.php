...
class Pilgrimage_Pricing_Bar extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if (function_exists('tk_register_package_info')) {
            $price_raw = preg_replace('/[^0-9]/', '', $settings['price']); // Extract numbers only
            tk_register_package_info([
                'price_from' => $price_raw,
                    ...
                    <?php if (!empty($settings['button_text'])): ?>
                        <div class="tk-pricing-bar__right">
                            <a href="<?php echo esc_url($settings['button_link']['url']); ?>"
                                class="tk-btn tk-btn--gold tk-pricing-bar__btn">
        ...
        <style>
            ...
            .tk-pricing-bar-placeholder {
                ...
                width: 100%;
                height: 100px;
                /* Approximate height, adjusted by JS */
            }
