                        ...
                        <div class="tk-booking-search__grid">
                            ...
                            <div class="tk-form-group tk-booking-search__field">
                                ...
                                <div class="tk-booking-search__dates">
                                    <input type="date" id="tk-booking-dates-start" name="travel_start" class="tk-form-input tk-booking-search__date">
                                    <span class="tk-booking-search__date-separator">&#8594;</span>
                                    <input type="date" id="tk-booking-dates-end" name="travel_end" class="tk-form-input tk-booking-search__date">
                                </div>
                            </div>
                            ...
                            <div class="tk-form-group tk-booking-search__field">
                                ...
                                <input type="number" id="tk-booking-travellers" name="group_size" class="tk-form-input" min="1" value="2">
                            </div>
