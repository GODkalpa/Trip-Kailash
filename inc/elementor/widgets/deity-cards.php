        ...
        <section class="tk-deity-section">
            ...
            <div class="tk-deity-cards">
                <?php if ( $shiva_enabled ) : ?>
                    <!-- Shiva Card -->
                    <div class="tk-deity-card tk-deity-card--shiva" style="background-image: url('<?php echo $shiva_background; ?>');">
                        ...
                        <a href="<?php echo $shiva_link; ?>" class="tk-deity-card__link" aria-label="<?php echo esc_attr( sprintf( __( 'Explore %s pilgrimages', 'trip-kailash' ), $shiva_title ) ); ?>"></a>
                    </div>
                <?php endif; ?>

                <?php if ( $vishnu_enabled ) : ?>
                    <!-- Vishnu Card -->
                    <div class="tk-deity-card tk-deity-card--vishnu" style="background-image: url('<?php echo $vishnu_background; ?>');">
                        <div class="tk-deity-card__overlay"></div>
                        <div class="tk-deity-card__content">
                        ...
                        <a href="<?php echo $vishnu_link; ?>" class="tk-deity-card__link" aria-label="<?php echo esc_attr( sprintf( __( 'Explore %s pilgrimages', 'trip-kailash' ), $vishnu_title ) ); ?>"></a>
                    </div>
                <?php endif; ?>

                <?php if ( $devi_enabled ) : ?>
                    <!-- Devi Card -->
                    <div class="tk-deity-card tk-deity-card--devi" style="background-image: url('<?php echo $devi_background; ?>');">
                        <div class="tk-deity-card__overlay"></div>
                        <div class="tk-deity-card__content">
                        ...
                        <a href="<?php echo $devi_link; ?>" class="tk-deity-card__link" aria-label="<?php echo esc_attr( sprintf( __( 'Explore %s pilgrimages', 'trip-kailash' ), $devi_title ) ); ?>"></a>
                    </div>
                <?php endif; ?>
                ...
                <?php if ( ! empty( $deity_cards ) ) : ?>
                    <?php foreach ( $deity_cards as $card ) : ?>
                        ...
                        ?>
                        <?php if ( $card_enabled ) : ?>
                            <div class="<?php echo esc_attr( $card_classes ); ?>" style="background-image: url('<?php echo $card_background; ?>');">
                                <div class="tk-deity-card__overlay"></div>
                                <div class="tk-deity-card__content">
                                ...
                                <a href="<?php echo $card_link; ?>" class="tk-deity-card__link" aria-label="<?php echo esc_attr( sprintf( __( 'Explore %s pilgrimages', 'trip-kailash' ), $card_title ) ); ?>"></a>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
